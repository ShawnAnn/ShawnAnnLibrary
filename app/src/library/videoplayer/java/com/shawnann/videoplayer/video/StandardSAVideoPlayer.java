...
public class StandardSAVideoPlayer extends SAVideoPlayer {
    ...
    public StandardSAVideoPlayer(Context context) {
        super(context);
    }

    public StandardSAVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void showProgressDialog(float deltaX, String seekTime, int seekTimePosition, String totalTime, int totalTimeDuration) {
        ...
        if (mProgressDialog == null) {
            ...
            if (mDialogProgressNormalColor != -11) {
                mDialogTotalTime.setTextColor(ResUtil.getColor(mDialogProgressNormalColor));
            }
            if (mDialogProgressHighLightColor != -11) {
                mDialogSeekTime.setTextColor(ResUtil.getColor(mDialogProgressHighLightColor));
            }
    ...
    @Override
    public SABaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        SABaseVideoPlayer gsyBaseVideoPlayer = super.startWindowFullscreen(context, actionBar, statusBar);
        if (gsyBaseVideoPlayer != null) {
            StandardSAVideoPlayer gsyVideoPlayer = (StandardSAVideoPlayer) gsyBaseVideoPlayer;
    ...
    @Override
    public SABaseVideoPlayer showSmallVideo(Point size, boolean actionBar, boolean statusBar) {
        SABaseVideoPlayer gsyBaseVideoPlayer = super.showSmallVideo(size, actionBar, statusBar);
        if (gsyBaseVideoPlayer != null) {
            StandardSAVideoPlayer gsyVideoPlayer = (StandardSAVideoPlayer) gsyBaseVideoPlayer;
            gsyVideoPlayer.setStandardVideoAllCallBack(mStandardVideoAllCallBack);
        }
