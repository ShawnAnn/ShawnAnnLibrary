...
/**
 * 播放和暂停的自定义控件，借(CAO)鉴(XI)自EnViews
...
public class ENPlayView extends View {
    ...
    public ENPlayView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.video_play);
        int lineColor = ta.getColor(R.styleable.video_play_line_color, DEFAULT_LINE_COLOR);
        int bgLineColor = ta.getColor(R.styleable.video_play_bg_line_color, DEFAULT_BG_LINE_COLOR);
        int lineWidth = ta.getInteger(R.styleable.video_play_line_width, DEFAULT_LINE_WIDTH);
        int bgLineWidth = ta.getInteger(R.styleable.video_play_bg_line_width, DEFAULT_BG_LINE_WIDTH);
        ta.recycle();
